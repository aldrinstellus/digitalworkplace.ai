        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-white/50 mt-1">Monitor and manage your search infrastructure</p>
            </div>
          ...
          {activeTab === "overview" && (
            <>
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
                <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-white/50 text-sm">Cluster Health</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-2xl font-medium text-white capitalize">{clusterHealth.status}</span>
                  </div>
                </div>

                <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-white/50 text-sm">Total Documents</span>
                    <FileText className="w-4 h-4 text-white/40" />
                  </div>
                  <div className="text-2xl font-medium text-white">{totalDocs.toLocaleString()}</div>
                </div>

                <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-white/50 text-sm">Active Nodes</span>
                    <Server className="w-4 h-4 text-white/40" />
                  </div>
                  <div className="text-2xl font-medium text-white">{clusterHealth.nodeCount}</div>
                </div>

                <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-white/50 text-sm">Active Shards</span>
                    <HardDrive className="w-4 h-4 text-white/40" />
                  </div>
                  <div className="text-2xl font-medium text-white">{clusterHealth.activeShards}</div>
                </div>
              </div>

              {/* Index Overview */}
              <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-6 mb-6">
                <h3 className="text-lg font-medium text-white mb-4">Index Overview</h3>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {indexStats.map((index) => (
                        <tr key={index.name} className="border-b border-white/5 hover:bg-white/5">
                          <td className="py-3 text-white font-mono text-sm">{index.name}</td>
                          <td className="py-3 text-white/70">{index.docCount.toLocaleString()}</td>
                          <td className="py-3 text-white/70">{index.size}</td>
                          <td className="py-3">
                          ...
                          <td className="py-3">
                            <div className="flex items-center gap-1">
                              ...
                              <button className="p-1.5 rounded hover:bg-red-500/20 text-white/40 hover:text-red-400">
              ...
              <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Node Health</h3>
                <div className="grid grid-cols-3 gap-4">
                  {nodeStats.map((node) => (
                    <div key={node.name} className="border border-white/10 rounded-xl p-4">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h4 className="text-white font-medium">{node.name}</h4>
                          <p className="text-xs text-white/40">{node.host}</p>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          <div className="flex items-center justify-between text-xs mb-1">
                            ...
                            <span className="text-white/70">{node.cpuUsage}%</span>
                          </div>
                        ...
                        <div>
                          <div className="flex items-center justify-between text-xs mb-1">
                            ...
                            <span className="text-white/70">{node.memoryUsage}%</span>
                          </div>
                          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                            <div
                              className={`h-full rounded-full ${node.memoryUsage > 80 ? "bg-red-500" : node.memoryUsage > 60 ? "bg-yellow-500" : "bg-blue-500"}`}
                        ...
                        <div>
                          <div className="flex items-center justify-between text-xs mb-1">
                            ...
                            <span className="text-white/70">{node.heapUsage}%</span>
                          </div>
                          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                            <div
          ...
          {activeTab === "operations" && (
            <div className="grid grid-cols-2 gap-6">
              {/* Indexing Operations */}
              <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Indexing Operations</h3>
                <div className="space-y-4">
                  <button
                    onClick={handleReindex}
                    disabled={reindexing}
                    className="w-full p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-left disabled:opacity-50"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Full Reindex</h4>
                        <p className="text-sm text-white/50">Reindex all content from Supabase</p>
                      </div>
                    </div>
                  </button>

                  <button className="w-full p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-left">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-green-500/20 flex items-center justify-center">
                        <Upload className="w-5 h-5 text-green-400" />
                      </div>
                      <div>
                        <h4 className="text-white font-medium">Sync New Content</h4>
                        <p className="text-sm text-white/50">Index recently added content</p>
                      </div>
                    </div>
                  </button>
                  ...
                  <button className="w-full p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Generate Demo Data</h4>
                        <p className="text-sm text-white/50">Create sample content for testing</p>
                      </div>
                    </div>
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  <button className="w-full p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Force Merge</h4>
                        <p className="text-sm text-white/50">Optimize index segments</p>
                      </div>
                    </div>
                  </button>
                  ...
                  <button className="w-full p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Create Snapshot</h4>
                        <p className="text-sm text-white/50">Backup indices to repository</p>
                      </div>
                    </div>
                  </button>
                  ...
                  <button className="w-full p-4 rounded-xl border border-red-500/30 hover:bg-red-500/10 transition-colors text-left">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-white/50">Delete all indexed data (irreversible)</p>
                      </div>
                    </div>
                  </button>
                </div>
          ...
          {activeTab === "indices" && (
            <div className="bg-[#0f0f14] border border-white/10 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-white">Index Management</h3>
              ...
              <div className="space-y-3">
                {indexStats.map((index) => (
                  <div
                    key={index.name}
                    className="flex items-center justify-between p-4 rounded-xl border border-white/10 hover:bg-white/5 transition-colors"
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-3 h-3 rounded-full ${index.health === "green" ? "bg-green-400" : index.health === "yellow" ? "bg-yellow-400" : "bg-red-400"}`} />
                      <div>
                        <h4 className="text-white font-mono">{index.name}</h4>
                        <p className="text-xs text-white/40">{index.docCount.toLocaleString()} docs | {index.size}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <button className="px-3 py-1.5 rounded-lg border border-white/10 hover:bg-white/5 text-white/70 text-sm flex items-center gap-1.5 transition-colors">
          ...
          {activeTab === "nodes" && (
            <div className="space-y-6">
              {nodeStats.map((node) => (
                <div key={node.name} className="bg-[#0f0f14] border border-white/10 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-medium">{node.name}</h4>
                        <p className="text-sm text-white/40">{node.host}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-4 gap-6">
                    <div>
                      ...
                      <div className="text-2xl font-medium text-white">{node.cpuUsage}%</div>
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-medium text-white">{node.memoryUsage}%</div>
                      <div className="mt-2 h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full ${node.memoryUsage > 80 ? "bg-red-500" : node.memoryUsage > 60 ? "bg-yellow-500" : "bg-blue-500"}`}
                          style={{ width: `${node.memoryUsage}%` }}
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <HardDrive className="w-4 h-4 text-white/40" />
                        <span className="text-sm text-white/50">Disk Usage</span>
                      </div>
                      <div className="text-2xl font-medium text-white">{node.diskUsage}%</div>
                      <div className="mt-2 h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Activity className="w-4 h-4 text-white/40" />
                        <span className="text-sm text-white/50">JVM Heap</span>
                      </div>
                      <div className="text-2xl font-medium text-white">{node.heapUsage}%</div>
                      <div className="mt-2 h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
