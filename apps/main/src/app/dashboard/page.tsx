          ...
          <div className="flex items-center justify-between h-12 sm:h-14 md:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {isSuperAdmin ? (
                <Link
                  href="/admin"
                  className="hidden md:flex items-center gap-1.5 px-3 py-1.5 bg-[#1a1a2e] hover:bg-[#1f1f35] border border-white/5 hover:border-white/10 rounded-lg transition-all hover:scale-[1.02]"
                >
              ...
              <>
                ...
                {product.guideUrl ? (
                  ...
                  <>
                    ...
                    <motion.button
                      disabled
                      className="px-2 py-2 rounded-full flex items-center border border-white/10 text-white/25 cursor-not-allowed"
                      title="Download Guide PDF"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
