# DSQ Demo Guide v2 - Support IQ (dSQ)

**Version**: 2.0.0 (Live Use Cases Edition)
...
#### Use Case 4: Unable to Access Features (User Access Management)

**Scenario**: User is unable to find the Survey's feature on Learn

| Step | Action | What Happens |
|------|--------|--------------|
| 1 | **Send email** to `demohelp@auzmorsupport.zohodesk.com` | Zoho Desk creates a new ticket (e.g., #1008) |
| | *Example*: "I am unable to access the Surveys feature on Auzmor Learn account https://sprint.learn-staging.auzmor.com/. The option is not visible on the Settings page. Please advise." | |
| 2 | Ask the dashboard: **"Show me Ticket-1008"** | `ticket-detail` widget displays ticket details, full conversation history, and an AI-generated draft response |
| 3 | Review the **AI Draft** | The draft contains step-by-step triaging performed by the Agent, RCA and suggested course of action |
| 4 | Click **Regenerate** and enter instructions | Enter: *"Make the draft more professional"* — AI regenerates the draft with updated tone |
| 5 | Click **Send Response** | Sends the AI-generated draft as an email reply to the customer via Zoho Desk |

---

#### Use Case 5: Cancellation / Refund Request (Subscription & Payment)

**Scenario**: User wants to cancel their Auzmor Learn subscription

| Step | Action | What Happens |
|------|--------|--------------|
| 1 | **Send email** to `demohelp@auzmorsupport.zohodesk.com` | Zoho Desk creates a new ticket (e.g., #1009) |
| | *Example*: "I would like to cancel my subscription of Auzmor Learn at the end of this month as we have the number of users are declining. Please let me know the next steps regarding this." | |
| 2 | Ask the dashboard: **"Show me Ticket-1009"** | `ticket-detail` widget displays ticket details, full conversation history, and an AI-generated draft response |
| 3 | Review the **AI Draft** | The draft contains step-by-step verification on subscription status and refund eligibility for the customer |
| 4 | Click **Regenerate** and enter instructions | Enter: *"Make the draft more professional"* — AI regenerates the draft with updated tone |
| 5 | Click **Send Response** | Sends the AI-generated draft as an email reply to the customer via Zoho Desk |

---

#### Use Case 6: API Key / Webhook Issue

**Scenario**: User wants to cancel their Auzmor Learn subscription

| Step | Action | What Happens |
|------|--------|--------------|
| 1 | **Send email** to `demohelp@auzmorsupport.zohodesk.com` | Zoho Desk creates a new ticket (e.g., #1010) |
| | *Example*: "I have configured a webhook named 'training notifications' in my Learn account https://sprint.learn-staging.auzmor.com/ but the events are not being received in our client app. Please advise." | |
| 2 | Ask the dashboard: **"Show me Ticket-1010"** | `ticket-detail` widget displays ticket details, full conversation history, and an AI-generated draft response |
| 3 | Review the **AI Draft** | The draft contains step-by-step triaging performed by the Agent, RCA and suggested course of action |
| 4 | Click **Regenerate** and enter instructions | Enter: *"Make the draft more professional"* — AI regenerates the draft with updated tone |
| 5 | Click **Send Response** | Sends the AI-generated draft as an email reply to the customer via Zoho Desk |
...
#### Use Case 7: Performance & Stability

**Scenario**: Application is slow to respond

| Step | Action | What Happens |
|------|--------|--------------|
| 1 | **Send email** to `demohelp@auzmorsupport.zohodesk.com` | Zoho Desk creates a new ticket (e.g., #1011) |
| | *Example*: "Auzmor Learn seems to be very slow today to respond. Pages are taking a long time to load and this is impacting productivity. Please provide a resolution." | |
| 2 | Ask the dashboard: **"Show me Ticket-1011"** | `ticket-detail` widget displays ticket details, full conversation history, and an AI-generated draft response |
| 3 | Review the **AI Draft** | The draft contains step-by-step triaging performed by the Agent, RCA and suggested course of action |
| 4 | Click **Regenerate** and enter instructions | Enter: *"Make the draft more professional"* — AI regenerates the draft with updated tone |
| 5 | Click **Send Response** | Sends the AI-generated draft as an email reply to the customer via Zoho Desk |
...
#### Use Case 8: Device / Environment

**Scenario**: Browser compatibility Issue

| Step | Action | What Happens |
|------|--------|--------------|
| 1 | **Send email** to `demohelp@auzmorsupport.zohodesk.com` | Zoho Desk creates a new ticket (e.g., #1012) |
| | *Example*: "The SCORM courses from Auzmor Learn are not rendering correctly in Brave browser which is my default browser. Please help with this issue." | |
| 2 | Ask the dashboard: **"Show me Ticket-1012"** | `ticket-detail` widget displays ticket details, full conversation history, and an AI-generated draft response |
| 3 | Review the **AI Draft** | The draft contains step-by-step triaging performed by the Agent, RCA and suggested course of action |
| 4 | Click **Regenerate** and enter instructions | Enter: *"Make the draft more professional"* — AI regenerates the draft with updated tone |
| 5 | Click **Send Response** | Sends the AI-generated draft as an email reply to the customer via Zoho Desk |
...
| **Personas** | 10 |
| **Modes** | 3 |
| **Live Use Cases** | 8 (Password Reset, Printer Issue, SCORM Import, User Access, Cancellation/Refund, API/Webhook, Performance, Browser Compatibility) |
| **Live Workflow Steps** | 40 (across all 8 use cases) |
